---
layout: post
title: "SDET. Context. It all depends on context!"
subtitle: "Automated API tests with Rest-Assured, WireMock and Allure"
date:   2023-01-07 14:00:59 -0700
categories: sdet
tags: [ spring-boot, java, testng, rest-assured, mockmvc, wiremock, mockito, h2, flyway, lombok, openapi, swagger, docker, jib, ssl, allure, actuator]
...
*Resource*: [Flyway getting started](https://thorben-janssen.com/flyway-getting-started/)
...
![pic-h2-console.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/pic-h2-console.png){: .mx-auto.d-block :}
**_Pic#3_**. DB - Access to the **H2** console in browser
{: style="text-align:center;"}

![pic-h2-db.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/pic-h2-db.png){: .mx-auto.d-block :}
**_Pic#4_**. Content of the DB table **HTTP_CODE** in **H2H2**
{: style="text-align:center;"}
...
![pic-pojo-entity.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/pic-pojo-entity.png){: .mx-auto.d-block :}
...
**a)** method: **getGeneralInformation()** - has no input
parameters and returns the fields with the description of the given
project (`core.yc.qa.http.codes.controllers.Info` - response `entity/POJO/model` implemented by Java record).
...
![records-info-controller-impl.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/records-info-controller-impl.png){: .mx-auto.d-block :}
...
**a)** method: **ResponseEntity\<HttpCode\> getResponseEntityById(Integer code)** - receives the status code whose response should be simulated; 
the response body contains reference information about that status code.

**Request:**
`GET /api/v1/http/code/example/{code}`

Response (XXX - xxx: status code depends from input)

![example-mimic-code.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/example-mimic-code.png){: .mx-auto.d-block :}
**_Pic#7.a_** (JSON) Response in Postman - `ExampleResponseController#getResponseEntityById()`
{: style="text-align:center;"}

![response-postman-xml.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/response-postman-xml.png){: .mx-auto.d-block :}
**_Pic#7.b_** (XML) Response of `ExampleResponseController#getResponseEntityById()`
{: style="text-align:center;"}

### 3.4 Documentation

**Swagger:** `https://server:port/context-path/swagger-ui.html`
...
![openapi-bean.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/openapi-bean.png){: .mx-auto.d-block :}
...
![springdoc_swagger-ui_open-api.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/springdoc_swagger-ui_open-api.png){: .mx-auto.d-block :}
**_Pic#9_**. OpenAPI documentation JSON (it's how Mozilla parse JSON by default)
{: style="text-align:center;"}
...
![springdoc_openapi_yaml.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/springdoc_openapi_yaml.png){: .mx-auto.d-block :}
...
![springdoc_swagger-ui_try-it.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/springdoc_swagger-ui_try-it.png){: .mx-auto.d-block :}
**_Pic#11_**. **Swagger UI**. Endpoint information
{: style="text-align:center;"}

![springdoc_swagger-ui_schema.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/springdoc_swagger-ui_schema.png){: .mx-auto.d-block :}
...
![core.yc.qa.test.e2e.InfoControllerTest.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/core.yc.qa.test.e2e.InfoControllerTest.png){: .mx-auto.d-block :}
**_Pic#13_**. SpringBoot server + Rest-Assured
{: style="text-align:center;"}
...
![core.yc.qa.test.integration.ExampleResponseControllerTest.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/core.yc.qa.test.integration.ExampleResponseControllerTest.png){: .mx-auto.d-block :}
...
![core.yc.qa.test.integration.mock.InfoControllerTest.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/core.yc.qa.test.integration.mock.InfoControllerTest.png){: .mx-auto.d-block :}
...
of the SpringBootTest/MockMvc injections - we will use the Mockito listener **MockitoTestNGListener.class** for that.
DB - will be mocked - **httpCodeRepository** (class - responsible to work with the DB) and **httpCodeService** class.

**Location:** `core.yc.qa.test.integration.mock.HttpCodeServiceImplTest`

![core.yc.qa.test.integration.mock.HttpCodeServiceImplTest.png](../resources/sdet/2022-09-05-http-status-codes-demo/images/core.yc.qa.test.integration.mock.HttpCodeServiceImplTest.png){: .mx-auto.d-block :}
...
![e2e.mock.HttpStatusCodeTest.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/e2e.mock.HttpStatusCodeTest.png){: .mx-auto.d-block :}
**_Pic#17_**. Rest-Assured + WireMock
{: style="text-align:center;"}

## 4.6 Allure report

I love Allure. It's open source; it's beautiful; It has nice features **Steps; Attachments; Links and Tms** - What also do you need for good
report and triage?

![allure-all.png](/resources/sdet/2022-09-05-http-status-codes-demo/images/allure-all.png){: .mx-auto.d-block :}
**_Pic#18_**. **Allure** report with all test suites and attachments (include the MockMvc requests)
{: style="text-align:center;"}
